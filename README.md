# MicroClouds
 ...
 新版本将新增启用Spring Boot + Shiro + Redis , 2018年12月19日开始更改,预计很快就完成更改 , 此次改动幅度较大, 所以新建了一个仓库 , 
...
7. 适合初学者学习,并且可以作为期末Java EE作业的参考,旧代码仓库到时候会更新.

8. 大幅优化 SQL语句, 表结构 . 最后会贴出相关表的SQL创建语句 .
